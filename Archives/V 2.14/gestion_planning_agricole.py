...
class PlanningApp(QMainWindow):
    ...
    def _id_ville(champ_ville):
        ...
        (posé par _choisir_ville, ou par _proposer_choix_villes pour
        l'historique) - None si l'utilisateur a tapé/modifié le texte
    ...
    def _proposer_choix_villes(self, candidats):
        ...
        self.edit_hist_ville.setProperty("meteociel_id", candidats[index].get("id"))
