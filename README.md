...
Pour pouvoir pleinement profiter de l'application, il faut lancer dans un terminal de commande :`pip install PyQt5 PyQtWebEngine pandas numpy requests beautifulsoup4 html5lib folium meteociel-api`
