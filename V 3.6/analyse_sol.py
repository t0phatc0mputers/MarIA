...
def calculer_besoin_planche(culture, surface_m2, produit=None, profil_sol=None):
    ...
    - produit : entrée de ENGRAIS_AMENDEMENTS (dict), ou None pour utiliser
      la première de la liste par défaut.
    ...
    Renvoie un dict {culture, produit, surface_m2, besoins_bruts_kg_ha,
    besoins_corriges_kg_ha, categories_sol, doses_par_nutriment,
    dose_produit_kg} ou None si la culture n'est pas reconnue."""
    ...
    produit = produit or ENGRAIS_AMENDEMENTS[0]
    ...
    return {
        "culture": fiche["espece"], "produit": produit["nom"], "surface_m2": surface_m2,
